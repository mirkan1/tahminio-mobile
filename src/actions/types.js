...
export const USER_SEARCH = 'user_search'; //take from authactions.js
...
export const GET_ANOTHER_USER_TROPHIES = 'get_another_trophies';
...
export const UPVODE_PREDICTION = 'upvote_prediction';
export const UNDO_UPVOTE_PREDICITON = 'undo_upvote_prediction';
